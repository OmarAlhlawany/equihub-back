<aside class="main-sidebar sidebar-collapse elevation-4" style="overflow-x: hidden;">
    ...
    <div class="sidebar">
        ...
        <div class="brand-container d-flex align-items-center justify-content-center" style="height: 70px; padding: 0.5rem; border-bottom: 1px solid rgba(0, 0, 0, 0.1);">
            <div class="d-flex align-items-center">
                <img src="{{ asset('images/logo.svg') }}" alt="EquiHub Logo" class="brand-image" style="height: 40px; width: auto; opacity: 0.8;">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu">
                ...
                <li class="nav-item">
                    ...
                    <img src="{{ asset('images/accounts-tab.svg') }}" class="nav-icon" 
                    style=" height: 20px; ">
                    <p>Accounts</p>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a href="{{ route('investor-insights') }}" class="nav-link {{ request()->is('investor-insights') ? 'active' : '' }}">
                    <img src="{{ asset('images/investors-insights-tab.svg') }}" class="nav-icon" style="height: 20px;">
                    <p>Investor Insights</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('startup-insights') }}" class="nav-link {{ request()->is('startup-insights') ? 'active' : '' }}">
                    <img src="{{ asset('images/startups-insights-tab.svg') }}" class="nav-icon" style="height: 20px;">
...
<style>
    ...
    .nav-icon {
    height: 24px; /* 👈 Change this value to control icon size */
    width: auto;
    transition: all 0.3s ease;
}
</style>