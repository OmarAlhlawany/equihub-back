            ...
            <div class="section-title mb-3 mt-4">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <textarea
                        ...
                        required>{{ old('problem_solved', $startup->problem_solved) }}</textarea>
                ...
                <div class="row">
                    ...
                    <textarea
                        ...
                        id="funding_used" name="funding_used" rows="3"
                        required>{{ old('funding_used', $startup->funding_used) }}</textarea>
                    @error('funding_used')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-12" style="display: flex; justify-content: flex-end !important;">
                    ...
                    <button type="submit" class="btn btn-primary"
                        style="width: 200px; height: 40.68px; border-radius: 9.63px; background-color: #134DF4; color: white; font-weight: 600; font-size: 11.98px; line-height: 13.31px; text-align: center; border: none;">
                        Update Startup
                    </button>
                </div>
                </div>
